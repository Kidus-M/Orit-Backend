  ...
  if (step === "quantity" && location && type) {
    ...
    return (
      <ClubSection title={type === "event" ? "Order Cases" : "Order Bottles"} onBack={() => setStep("location")}>
        ...
        {type === "event" ? <div className="club-disclaimer"><strong>Disclaimer: Orders will be ready for pickup after 3 days and must be picked up on the third day.</strong></div> : null}
