    ...
    const [
      ...
      db
        .select({
          ...
          abcLicenseType: locations.abcLicenseType,
          abcLicenseNumber: locations.abcLicenseNumber,
          responsibleOperator: locations.responsibleOperator,
          complianceApproved: locations.complianceApproved,
